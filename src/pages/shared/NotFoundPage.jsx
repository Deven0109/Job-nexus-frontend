    ...
    return (
        <div className="min-h-[60vh] flex items-center justify-center py-12 px-4">
            <div className="text-center">
                ...
                <p className="text-dark-500 text-sm mb-8 max-w-sm mx-auto">The page you're looking for doesn't exist or has been moved.</p>
                <Link to="/" className="inline-flex items-center gap-2 px-6 py-2.5 gradient-primary text-white font-semibold rounded-lg text-sm hover:opacity-90 transition-opacity">Go Home</Link>
            </div>
        </div>
    );
};
